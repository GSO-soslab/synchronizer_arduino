...
/**
**1) set up timer based on trigger rate
**2) send the trigger singal
**3) measure time 
**/
...
//   }
//   if (topic.length() == 0) {
//     error((topic_ + " (Sensor.cpp): PPS topic is empty.").c_str(), 51);
//   }
// }
...
void Sensor::newMeasurementIsAvailable() { new_measurement_available_++; }
