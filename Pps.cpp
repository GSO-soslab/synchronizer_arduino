...
/** Set timer TCC2 generate a 100ms pulse every second on D13 **/
  ...
  TCC2->CC[1].reg = 4687;                        // Set the TCC2 CC1 register to generate a duty cycle of 10% (100ms)
  ...
  TCC2->CTRLA.reg = TCC_CTRLA_PRESCSYNC_PRESC |  // Reset timer on the next prescaler clock
                    // TCC_CTRLA_PRESCALER_DIV256; // Set prescaler to 256, 48MHz/256 = 187500kHz                       
